...
class Game:
    ...
    def __init__(self):
        ...
        self.car1 = GameObj(0, 560, 160, 40)
        self.car2 = GameObj(0, 600, 160, 40)
        self.car3 = GameObj(0, 640, 160, 40)
        self.car4 = GameObj(0, 680, 160, 40)
        self.car5 = GameObj(0, 720, 160, 40)

        self.raft1 = GameObj(0, 400, 160, 40,)
        self.raft2 = GameObj(0, 360, 160, 40,)
        self.raft3 = GameObj(0, 320, 160, 40,)
        self.raft4 = GameObj(0, 440, 160, 40,)
        self.raft5 = GameObj(0, 480, 160, 40,)
    ...
    def draw(self):
        ...
        self.car1.draw(self.window, (255, 0, 0))
        self.car2.draw(self.window, (255, 0, 0))
        self.car3.draw(self.window, (255, 0, 0))
        self.car4.draw(self.window, (255, 0, 0))
        self.car5.draw(self.window, (255, 0, 0))


        self.raft1.draw(self.window, (255, 0 ,255))
        self.raft2.draw(self.window, (255, 0 ,255))
        self.raft3.draw(self.window, (255, 0 ,255))
        self.raft4.draw(self.window, (255, 0, 255))
        self.raft5.draw(self.window, (255, 0, 255))
    ...
    def move(self):
        ...
        self.raft4.x -= self.raft_speed
        self.raft5.x += self.raft_speed
        if self.car1.x >= 1000 or self.car3.x >= 1000 or self.car5.x >= 1000:
            self.car1.x = 0 - self.car1.width
            self.car3.x = 0 - self.car3.width
            self.car5.x = 0 - self.car5.width
        if self.car2.x < -1 or self.car4.x < -1:
            self.car2.x = 1000
            self.car4.x = 1000
        
        if self.raft1.x >= 1000 or self.raft3.x >= 1000 or self.raft5.x >= 1000:
            self.raft1.x = 0 - self.raft1.width
            self.raft3.x = 0 - self.raft3.width
            self.raft5.x = 0 - self.raft3.width
        if self.raft2.x < -1 or self.raft4.x < -1:
            self.raft2.x = 1000
            self.raft4.x = 1000

    def collide(self):
        if self.player.get_hitbox().colliderect(self.car1.get_hitbox()) == True:
            print("Your Dead Car")
            self.when_dead()
        if self.player.get_hitbox().colliderect(self.car2.get_hitbox()) == True:
            print("Your Dead Car")
            self.when_dead()
        if self.player.get_hitbox().colliderect(self.car3.get_hitbox()) == True:
            print("Your Dead Car")
            self.when_dead()
        if self.player.get_hitbox().colliderect(self.car4.get_hitbox()) == True:
            print("Your Dead Car")
            self.when_dead()
        if self.player.get_hitbox().colliderect(self.car5.get_hitbox()) == True:
            print("Your Dead Car")
            self.when_dead()
        ...
        if self.player.get_hitbox().colliderect(self.raft3.get_hitbox()) == True:
            self.player.x += self.raft_speed
        if self.player.get_hitbox().colliderect(self.raft4.get_hitbox()) == True:
            self.player.x -= self.raft_speed
        if self.player.get_hitbox().colliderect(self.raft5.get_hitbox()) == True:
            self.player.x += self.raft_speed

        if self.player.get_hitbox().colliderect(self.water.get_hitbox()) == True:
            if self.player.get_hitbox().colliderect(self.raft1.get_hitbox()) != True and self.player.get_hitbox().colliderect(self.raft2.get_hitbox()) != True and self.player.get_hitbox().colliderect(self.raft3.get_hitbox()) != True and self.player.get_hitbox().colliderect(self.raft4.get_hitbox()) != True and self.player.get_hitbox().colliderect(self.raft5.get_hitbox()) != True:
        ...
        if self.player.get_hitbox().colliderect(self.fly.get_hitbox()) == True:
            ...
            self.fly.y = random.randint(0, 780)
            self.has_fly += 1
            if self.fly.x == self.raft1.x or self.raft2.x or self.raft3.x or self.raft4.x or self.raft5.x and self.fly.y == self.raft1.y:
